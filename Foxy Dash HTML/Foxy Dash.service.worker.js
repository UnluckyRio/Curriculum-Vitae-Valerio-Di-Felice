...
/** @type {string[]} */
const CACHED_FILES = ["Foxy Dash.html","Foxy Dash.js","Foxy Dash.offline.html","Foxy Dash.icon.png","Foxy Dash.apple-touch-icon.png","Foxy Dash.audio.worklet.js","Foxy Dash.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Foxy Dash.wasm","Foxy Dash.pck"];
