...
function initPrintFunction() {
  ...
  printButton.className =
    "fixed bottom-6 right-6 bg-primary-600 text-white px-4 py-2 rounded-full shadow-lg hover:bg-primary-700 transition-colors duration-200 print:hidden";
...
function initThemeToggle() {
  ...
  themeToggle.className =
    "fixed bottom-6 left-6 bg-gray-800 text-white p-3 rounded-full shadow-lg hover:bg-gray-700 transition-colors duration-200 print:hidden";
